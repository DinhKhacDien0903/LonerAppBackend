...
{
    public class GetProfileDetailForAdminHandler : IRequestHandler<GetProfileDetailForAdminRequest, Result<GetProfileDetailResponse>>
    {
        private readonly IUnitOfWork _uow;
        public GetProfileDetailForAdminHandler(IUnitOfWork uow)
        {
            _uow = uow;
        }

        public async Task<Result<GetProfileDetailResponse>> Handle(GetProfileDetailForAdminRequest request, CancellationToken cancellationToken)
        {
